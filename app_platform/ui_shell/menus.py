...
class MenuSignals(QObject):
    ...
    close_file = Signal()
    run_script = Signal()
    debug_script = Signal()  # <--- [NEW] Debug Signal
...
class MainMenuBar(QMenuBar):
    ...
    def build_menus(self):
        ...
        # [NEW] Debug Action
        debug_script = QAction("Debug Script", self)
        debug_script.setShortcut("F9")
        debug_script.triggered.connect(self.signals.debug_script.emit)
        run_menu.addAction(debug_script)
        ...
        help_action = QAction("About Mathex", self)
