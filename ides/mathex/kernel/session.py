...
# [NEW] Image Processing Toolbox (Robust Import)
try:
    import mathex.toolbox.images as images
except ImportError:
    images = None
...
class KernelSession:
    ...
    def reset(self):
        ...
        # [NEW] Register Image Processing Tools
        if images:
            self.globals.update({
                ...
                "imfilter": images.imfilter, # Distinct from signal 'filter'
            })
